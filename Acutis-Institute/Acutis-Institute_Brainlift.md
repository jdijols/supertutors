...
- **Jason Dijols**
  ...
  - **Expertise:** Full-stack engineering (React, React Native, TypeScript, Node.js, Express, Next.js, MongoDB); AI orchestration (Cursor, Claude, OpenAI, OpenClaw, agentic workflow design); design systems and journey mapping (Figma, Fullstory); operations-driven UX (internal mobile app at Kith that drove a 24% revenue lift).
...
- **Ask (phased):**
  ...
  - **Phase 3 (federation, conditional on Phase 2 maturity):** Multi-campus operating support; shared Brand and Guides infrastructure.
- **Operational Dependencies (phased):**
  - **Phase 1 — Catholic homeschool cohort partnership (Q3 2026):**
    - Virtue Curriculum Lead (designs Your-Saint-Today micro-curriculum and Catholic-themed personalization overlay on the Timeback academic engine)
    - Pilot Family Recruitment Lead (works existing Kolbe, Mater Amabilis, and Seton networks in greater Austin)
    - Founding philanthropy contact at pilot scale (Knights of Columbus regional partnership, Austin Catholic donor network, or Lynch Foundation)
  - **Phase 2 — Austin physical micro-campus (Q3 2027):**
    - Head of School with sacramental-Catholic operating history (NAPCIS- or Chesterton-Schools-Network-alumni candidates preferred)
    - Chaplain plus parish-of-record letter of intent (Diocese of Austin: St. Mary Cathedral, St. Louis King of France, or St. William as likely partner parishes)
    - Safe Environment Coordinator with active Diocese of Austin VIRTUS certification
    - Two founding Guides credentialed in Catholic catechesis and AI-assisted instruction
    - NAPCIS accreditation pursuit, year one of campus operation
  - **Phase 3 — Federation (Q3 2029+):**
    - Replication playbook (curriculum, operations, governance template)
...
- **SPOV1:** Timeback's portfolio is currently differentiated by *interest segments* (Alpha = general; Texas Sports Academy = sports; NextGen Academy = gaming; GT School = gifted; Montessorium = Montessori method; plus Alpha High, Alpha Anywhere, Nova, Prequel, Unbound, Novatio, learn + earn). Acutis introduces the first **values-identity segment** to the portfolio: Catholic families, who self-select into Catholic-identity schools at densities no interest segment matches, and who already self-select *out* of secular schooling at scale (~3.4M US Catholic homeschoolers, 2x parochial enrollment). This is the next dimension of specialization Timeback can host, not a dimension it currently serves. Liemandt's stated TAM of "1 billion students over the next 20 years" requires reaching identity-coherent cohorts at scale; the Catholic cohort is the largest such cohort globally (1.422B adherents, 17.8% of humanity, single largest religious denomination on Earth). **Solution:** Position Acutis as the **Catholic-formation specialized school** on the Timeback platform, structurally parallel to how Montessorium overlays the Montessori method or Texas Sports Academy themes the skill-building afternoon around athletics. Same Timeback academic engine, same Guides model, themed skill-building afternoon (sacramental life, virtue formation, Catholic project work, Carlo-style web evangelization capstones). Superbuilders extracts platform fees; Acutis funds via tuition + endowment + Catholic philanthropic capital (Knights of Columbus, Catholic foundations, lay philanthropists); zero diocesan liability on the platform.
  <details>
  <summary><b>Supporting Research</b></summary>
...
- **Insight 4:** Canon 803 §3's bishop-recognition gate is not a bureaucratic obstacle; it is a permission slip the diocese cannot revoke from a non-owned institution, and the operational case-study record spans 50+ years and four scaling tiers. Holy Angels Academy (1973) proves the multi-decade single-school tier; Avalon and Everest the recent single-school tier with bishop recognition; Chesterton the federated network (~70); Regnum Christi/Semper Altius the global federation (154 schools, 19 countries). Each is a 501(c)(3) with a self-perpetuating lay board, no diocesan subsidy, voluntary doctrinal alignment.
  <details>
  <summary><b>Connections</b></summary>
...
- **Main views:** Architect of the 2-Hour Learning model and the Timeback platform ("Shopify for schools"). Committed $1B and 20 years to fixing American K-12. Stated TAM: 1 billion students over the next 20 years via Timeback. Frames the Timeback portfolio as "distinct schools for distinct segments" (sports-focused, gifted, general population, and now Montessori).
- **Why Follow:** Acutis is explicitly the Catholic-formation specialized school on Liemandt's Timeback platform; his long-form interviews are the source documents for SPOV1 and SPOV2.
- **Locations:**
  - Knowledge Project podcast: [fs.blog/knowledge-project-podcast/joe-liemandt](https://fs.blog/knowledge-project-podcast/joe-liemandt/)
  - Colossus / Patrick O'Shaughnessy: [colossus.com/article/joe-liemandt-class-dismissed](https://colossus.com/article/joe-liemandt-class-dismissed/)
  - Peter Attia podcast #366: [peterattiamd.com/joeliemandt](https://peterattiamd.com/joeliemandt/)
  - Alpha School profile: [alpha.school/joe-liemandt-and-the-future-of-education](https://alpha.school/joe-liemandt-and-the-future-of-education/)

</details>

<details>
<summary><b>Expert 2 — MacKenzie Price</b> (Operator, Alpha School & 2 Hour Learning CEO)</summary>

- **Main views:** Co-founder and CEO of Alpha School and 2 Hour Learning. Stanford-trained psychologist. Argues motivation, not content delivery, is the K-12 bottleneck; Alpha students score top 1–2% nationally with 90%+ enjoying school. Her model now powers Alpha, Alpha High, Texas Sports Academy, GT School, NextGen, and Montessorium.
- **Why Follow:** Operational voice of the Timeback specialized-school pattern (Liemandt is the philosopher). Her LinkedIn and X feeds are the running playbook for how a Timeback school runs day-to-day.
- **Locations:**
  - 2 Hour Learning founder page: [2hourlearning.com/founder](https://2hourlearning.com/founder/)
  - LinkedIn: [linkedin.com/in/mackenzielprice](https://www.linkedin.com/in/mackenzielprice/)
  - X: [x.com/mackenzieprice](https://x.com/mackenzieprice)

</details>

<details>
<summary><b>Expert 3 — Wes Kao</b> (Builder, Maven co-founder, SPOV framework author)</summary>

- **Main views:** Co-founder of Maven (a16z/First Round) and altMBA (with Seth Godin). Author of the Spiky Point of View framework this Brainlift is built on. Argues differentiation requires defensible, disagreeable positions.
- **Why Follow:** Acutis's five SPOVs are Kao's framework applied to Catholic K-12. Methodological literacy a hiring committee will check first.
- **Locations:**
  - Personal site: [weskao.com](https://www.weskao.com/)
  - SPOV essay: [weskao.com/blog/my-spiky-points-of-view](https://www.weskao.com/blog/my-spiky-points-of-view-15-examples-to-inspire-your-spov)
  - Newsletter: [newsletter.weskao.com](https://newsletter.weskao.com/)
  - LinkedIn: [linkedin.com/in/weskao](https://www.linkedin.com/in/weskao/)
  - X: [twitter.com/wes_kao](https://twitter.com/wes_kao)

</details>

<details>
<summary><b>Expert 4 — Ethan Mollick</b> (Researcher, Wharton AI-in-education)</summary>

- **Main views:** Wharton professor (Ralph J. Roberts Distinguished Faculty Scholar). Author of *Co-Intelligence* (NYT bestseller) and "Centaurs and Cyborgs on the Jagged Frontier." Argues AI in education is most effective as co-intelligence, not as teacher replacement.
- **Why Follow:** Only AI-in-education researcher whose empirical work has actually shaped how schools deploy LLMs. *One Useful Thing* Substack is where the field debates AI-tutored mastery and formation.
- **Locations:**
  - Substack: [oneusefulthing.org](https://www.oneusefulthing.org/)
  - Wharton profile: [mgmt.wharton.upenn.edu/profile/emollick](https://mgmt.wharton.upenn.edu/profile/emollick/)
  - X: [x.com/emollick](https://x.com/emollick)
  - *Co-Intelligence* book: [amazon.com/Co-Intelligence](https://www.amazon.com/Co-Intelligence-Living-Working-Ethan-Mollick/dp/059371671X)

</details>

<details>
<summary><b>Expert 5 — Dale Ahlquist</b> (Operator, Chesterton Schools Network founder)</summary>

- **Main views:** Co-founder of Chesterton Academy (2008) and the Chesterton Schools Network (70+ schools across 10 countries), the largest lay-led Catholic-classical school network, built outside diocesan structure. President of the American Chesterton Society. Argues Catholic education recovery happens through parent-founded, lay-governed academies, not diocesan reform.
- **Why Follow:** Living operational proof of SPOV4. Chesterton is Acutis's nearest existing analog; Acutis differentiates by adding AI-native (Timeback) capability to a curriculum lane Chesterton occupies with classical-only.
- **Locations:**
  - American Chesterton Society: [chesterton.org/dale-ahlquist](https://www.chesterton.org/dale-ahlquist/)
  - Chesterton Schools Network: [chestertonschoolsnetwork.org/about](https://chestertonschoolsnetwork.org/about)
  - LinkedIn: [linkedin.com/in/dale-ahlquist-1b77746](https://www.linkedin.com/in/dale-ahlquist-1b77746)
  - Word on Fire interview: [wordonfire.org/articles/leaders-in-catholic-education-dale-ahlquists-call-from-chesterton](https://www.wordonfire.org/articles/leaders-in-catholic-education-dale-ahlquists-call-from-chesterton/)
...
- **Category 1.1: Enrollment & Trends**
  - **Source 1: NCEA, Catholic Schools by the Numbers (2024–25)**
    - **URL:** [ncea.org](https://ncea.org/NCEA/NCEA/How_We_Serve/News/Press_Releases/Catholic-Schools-by-the-Numbers-New-Data-Reveals-Trends-in-Enrollment-Staffing-and-Demographics.aspx)
    - **DOK 1 - Facts:**
...
- **Category 1.2: Independent Catholic Networks**
  - **Source 1: Chesterton Schools Network, 2025 Yass Prize announcement**
    ...
    - **DOK 1 - Facts:**
      - Grew from 1 academy (2008) to 70+ schools across 30 states and 10 countries.
      - 3,000+ current students.
      - Targets: 22 new schools in 2026, 150 by 2030.
    - **DOK 2 - Summary:** Most relevant operational analog for Acutis Phase 3 federation. Acutis differentiates by AI-native (Timeback) capability vs. Chesterton's classical-only.
  - **Source 2: NAPCIS About + Accreditation Standards**
    - **URL:** [napcis.org/about](https://napcis.org/about/)
    - **DOK 1 - Facts:**
      - Founded 1995; 87 member schools, 12,800 students, 34 states.
      - Annual Profession of Faith and Oath of Fidelity to the Magisterium required of board, administration, faculty.
      - Merging into Cardinal Newman Society in 2026.
    - **DOK 2 - Summary:** Provides the institutional fidelity guardrail Acutis needs in Phase 2 without diocesan ownership.
- **Category 1.3: Parochial Strain**
  - **Source 1: Diocese of Brooklyn, Seven Catholic School Closures (2025)**
    - **URL:** [dioceseofbrooklyn.org](https://dioceseofbrooklyn.org/press-releases/diocese-of-brooklyn-announces-closure-of-seven-catholic-schools-at-end-of-academic-year/)
    - **DOK 1 - Facts:**
      - Seven schools closed in one diocese in one year.
      - Cited reasons: enrollment declines since 2019, multi-million-dollar deficits.
    - **DOK 2 - Summary:** Concrete evidence the parochial real-estate-heavy model is structurally failing. Independent lay apostolates are the operational successor.

</details>

<details>
<summary><b>Category 2 — Learning Science & Motivational Architecture</b></summary>

- **Category 2.1: Self-Determination Theory**
  - **Source 1: Ryan & Deci (2000), Self-Determination Theory paper**
    - **URL:** [selfdeterminationtheory.org](https://selfdeterminationtheory.org/SDT/documents/2000_RyanDeci_SDT.pdf)
    - **DOK 1 - Facts:**
...
- **Category 2.2: Mastery & Cognitive Architecture**
  - **Source 1: Bloom (1984), The 2 Sigma Problem**
    ...
    - **DOK 1 - Facts:**
      - Tutored mastery learning outperforms conventional teaching by 2 standard deviations.
      - The "2 Sigma Problem": deliver 1:1 tutoring outcomes at scale.
      - Educational Researcher 13(6).
    - **DOK 2 - Summary:** Bloom defined the unsolved problem Timeback claims to solve via AI tutoring. Acutis adds the motivational gain Bloom assumed tutoring alone could deliver.
- **Category 2.3: Classical & Theological Foundations**
  - **Source 1: Aquinas, Summa Theologiae II-II Q.47 (On Prudence)**
    - **URL:** [newadvent.org/summa/3047](https://www.newadvent.org/summa/3047.htm)
    - **DOK 1 - Facts:**
  ...
  - **Source 2: Code of Canon Law, Canons 793–821 (Vatican 1983)**
    ...
    - **DOK 1 - Facts:**
      - Canon 803 §1 defines a Catholic school as one a competent ecclesiastical authority recognizes through a written document.
      - Canon 803 §2 requires instruction "grounded in the principles of Catholic doctrine."
      - Canon 803 §3 requires bishop consent to use "Catholic school" naming.
    - **DOK 2 - Summary:** The bishop-recognition gate is a written-document threshold, not a diocesan-ownership requirement. Independent lay apostolates clear it routinely.

</details>

<details>
<summary><b>Category 3 — Providential Timing & Timeback Ecosystem</b></summary>

- **Category 3.1: Magnifica humanitas & Carlo Acutis Canonization**
  - **Source 1: Vatican News, Pope Leo XIV's first encyclical (May 2026)**
    - **URL:** [vaticannews.va](https://www.vaticannews.va/en/pope/news/2026-05/pope-leo-xiv-first-encyclical-magnifica-humanitas.html)
    - **DOK 1 - Facts:**
      - Signed May 15, 2026 (135th anniversary of Rerum Novarum).
      - Published May 25, 2026.
      - Full title: "Magnifica Humanitas: On the Protection of Human Dignity in the Age of Artificial Intelligence."
    - **DOK 2 - Summary:** Vatican's deliberate anniversary timing signals Magnifica humanitas is meant to do for AI what Rerum Novarum did for industrialization.
  - **Source 2: America Magazine, "Pope Leo will publish first encyclical, 'Magnifica Humanitas'" (May 18, 2026)**
    - **URL:** [americamagazine.org](https://www.americamagazine.org/vatican-dispatch/2026/05/18/pope-leo-encyclical-artifical-intelligence-anthropic/)
    - **DOK 1 - Facts:**
      - Vatican press conference May 25, 2026 in Synod Hall.
      - Presenters: Cardinals Fernández, Czerny, Parolin, theologians Anna Rowlands and Léocadie Lushombo, plus Anthropic co-founder Christopher Olah.
      - First time a pope personally attends a Vatican press conference for his own social encyclical.
    - **DOK 2 - Summary:** The Anthropic-at-Vatican detail is the unfakeable centerpiece of SPOV5's providential-timing argument.
  - **Source 3: Vatican.va, Pope Leo XIV homily for Acutis canonization (Sept 7, 2025)**
    - **URL:** [vatican.va](https://www.vatican.va/content/leo-xiv/en/homilies/2025/documents/20250907-omelia-frassati-acutis.html)
    - **DOK 1 - Facts:**
...
- **Category 3.3: Timeback Ecosystem**
  - **Source 1: 2 Hour Learning (Timeback platform) portfolio**
    ...
    - **DOK 1 - Facts:**
      - Portfolio (per site footer): Alpha School, Alpha High School, Alpha Anywhere, Texas Sports Academy, GT School, NextGen Academy, Nova Academy, Prequel, Unbound Academy, The Novatio School, Montessorium, learn + earn.
      - Architecture: same AI-personalized academic morning, themed skill-building afternoon per specialized school.
      - Stated promise: "four hours…packed with sports, arts, entrepreneurship" in the skill-building afternoon block.
    - **DOK 2 - Summary:** The Timeback portfolio is structurally one academic engine plus N specialized-school themes. Acutis is the Catholic-formation specialized school in that pattern.
  - **Source 2: Alpha School, "Alpha's motivation formula" blog**
    - **URL:** [alpha.school/blog/from-i-hate-school-to-can-we-skip-summer-alphas-motivation-formula](https://alpha.school/blog/from-i-hate-school-to-can-we-skip-summer-alphas-motivation-formula/)
    - **DOK 1 - Facts:**
  ...
  - **Source 4: Mike Maples Jr., "Superbuilders are a Startup's X-Factor" (Medium, July 2024)**
    ...
    - **DOK 1 - Facts:**
      - Superbuilder defined: "technical prowess, insatiable curiosity, unwavering tenacity, staunch belief in their capability to surmount any technical hurdle."
      - Cites Kyle Vogt at the 2008 Olympics as archetype.
    - **DOK 2 - Summary:** Canonical definition of the figure Superbuilders is named for. Acutis Owners section is calibrated to this archetype.
  - **Source 5: Agenzia Fides, Vatican Catholic Church Statistics 2024**
    - **URL:** [fides.org](https://www.fides.org/en/news/75542-VATICAN_CATHOLIC_CHURCH_STATISTICS_2024)
    - **DOK 1 - Facts:**
